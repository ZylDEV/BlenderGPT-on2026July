...
![BlenderGPT Demo](https://user-images.githubusercontent.com/63528145/227158577-d92c6e8d-df21-4461-a69b-9e7cde8c8dcf.mov)
...
- 🖥️ **Show Code** — View, inspect, and re-run generated scripts in Blender's Text Editor
...
> **💡 Tip:** If you're developing locally, you can also symlink the folder to Blender's add-ons directory:
...
4. Type your command in natural language, e.g.:
...
BlenderGPT supports any API that is **OpenAI-compatible** (OpenAI, Groq, Together AI, Anthropic via proxy, etc.). Here's how to customize:
...
client = OpenAI(
    api_key="not-needed",  # doesn't matter
...
> **⚠️ Note:** When switching providers, make sure your API key matches the provider you selected, and the model name is supported by that provider.
...
| **DeepSeek Reasoner** | Advanced reasoning model | Complex 3D math & logic |
